...
output  [31:0] img_3_rows_V_out_din;
input   img_3_rows_V_out_full_n;
output   img_3_rows_V_out_write;
output  [31:0] img_3_cols_V_out_din;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (img_3_cols_V_out_full_n == 1'b0) | (img_3_rows_V_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (img_3_cols_V_out_full_n == 1'b0) | (img_3_rows_V_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (img_3_cols_V_out_full_n == 1'b0) | (img_3_rows_V_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign img_3_cols_V_out_din = cols;

assign img_3_rows_V_out_din = rows;
